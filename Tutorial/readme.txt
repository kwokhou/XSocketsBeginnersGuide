...
However we also have usage of XSockets in other areas... 
You can send messages through XSockets from for example:
	- A netduino (I made a demo in the fall of 2012)
		link: http://twitter.yfrog.com/0bvluwjdjnwhquzuvprjeigwz
	- Kinect (We did a virtual receptionist for Voxeo in 2011)
		link: http://www.youtube.com/watch?v=VilJpRXAafs

To wrap that short intro up... 
Do not look at XSockets as a websocket server. Look at it as a realtimecommunication framework
